...
const Footer = () => {
  return (
    <footer className="bg-[#2d1a5b] text-white py-20">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-6">
            <div className="grid grid-cols-4 gap-6">
              {/* San Francisco */}
              <div className="col-span-4 bg-[#8b5cf6]/30 p-8 rounded-3xl backdrop-blur-sm">
                ...
                <p className="text-sm pl-9">United States, 677 Harrison Street, San Francisco, CA 94107</p>
              </div>
              ...
              <div className="col-span-2 bg-[#8b5cf6]/30 p-8 rounded-3xl backdrop-blur-sm">
                ...
                <p className="text-sm pl-9">United Kingdom, Brickfields Workspace, London, E2 8HD</p>
              </div>
              ...
              <div className="col-span-2 bg-[#8b5cf6]/30 p-8 rounded-3xl flex items-center space-x-6 backdrop-blur-sm">
                <a href="https://www.linkedin.com/company/11x-ai/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center hover:text-blue-300">
                ...
                <a href="https://x.com/11x_official" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center hover:text-blue-300">
                  <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 32 33" fill="none">
              ...
              {/* Certification */}
              <div className="col-span-2 bg-[#8b5cf6]/30 p-8 rounded-3xl flex items-center justify-center backdrop-blur-sm">
                <a href="https://app.getdelve.com/11x" target="_blank" rel="noopener noreferrer">
                  <img src="https://cdn.prod.website-files.com/66fe5a1a88c73ef8f270d312/67311f17856facccfe66988d_soc2.webp" alt="SOC2 Certification" className="h-12" />
                </a>
              </div>
            </div>
            
            {/* Copyright */}
            <div className="mt-6 text-sm text-center lg:text-left">
