        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-6 ">
              {/* Logo */}
              <div className="bg-[#8b5cf6]/30 p-6 md:p-8 rounded-3xl backdrop-blur-sm">
            ...
            <div className="h-full">
              <div className="bg-[#8b5cf6]/30 p-6 md:p-8 rounded-3xl h-fit backdrop-blur-sm">
          ...
          <div className="lg:col-span-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              {/* UK Address */}
              <div className="md:col-span-2 bg-[#8b5cf6]/30 p-6 md:p-8 rounded-3xl backdrop-blur-sm">
              ...
              {/* Social Media */}
              <div className="md:col-span-2 bg-[#8b5cf6]/30 p-6 md:p-8 rounded-3xl flex items-center space-x-6 backdrop-blur-sm">
              ...
              <div className="md:hidden text-center p-4">
                <p className="text-sm">© All rights reserved 2025 11x AI Inc.</p>
              </div>
